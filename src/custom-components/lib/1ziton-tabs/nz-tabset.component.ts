  ...
  template: `
    <div [ngClass]="_classMap" #hostContent>
      <yzt-tabs-nav
        ...
        <div
          yzt-tab-label
          [class.yzt-tabs-tab-active]="(nzSelectedIndex == i)&&!nzHide"
      ...
      <div class="yzt-tabs-content"
           #tabContent
           [class.yzt-tabs-content-animated]="tabPaneAnimated"
           [class.yzt-tabs-content-no-animated]="!tabPaneAnimated"
           [style.margin-left.%]="tabPaneAnimated&&(-nzSelectedIndex*100)">
        <yzt-tab-body
          class="yzt-tabs-tabpane"
          [class.yzt-tabs-tabpane-active]="(nzSelectedIndex == i)&&!nzHide"
          [class.yzt-tabs-tabpane-inactive]="(nzSelectedIndex != i)||nzHide"
          [content]="tab.content"
          *ngFor="let tab of _tabs; let i = index">
        </yzt-tab-body>
      </div>
...
export class YztTabSetComponent implements AfterContentChecked, OnInit, AfterViewInit {
  _el;
  _classMap;
  _prefixCls = 'yzt-tabs';
  _width;
  ...
  ngAfterContentChecked(): void {
    ...
    this._tabs.forEach((tab: YztTabComponent, index: number) => {
