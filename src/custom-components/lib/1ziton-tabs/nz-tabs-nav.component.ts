...
@Component({
  ...
  template     : `
    ...
    <div class="nz-tabs-nav-container" [class.ant-tabs-nav-container-scrolling]="_showPaginationControls" #tabListContainer>
      ...
      <div class="ant-tabs-nav-wrap">
        <div class="ant-tabs-nav-scroll">
          <div class="ant-tabs-nav" [class.ant-tabs-nav-animated]="nzAnimated" #tabList (cdkObserveContent)="_onContentChanges()">
            <div yzt-tabs-ink-bar [hidden]="nzHideBar" [nzAnimated]="nzAnimated" [nzPositionMode]="nzPositionMode" style="display: block;"></div>
...
export class YztTabsNavComponent implements AfterContentChecked, AfterContentInit {
  ...
  @ContentChildren(YztTabLabelDirective) _labelWrappers: QueryList<YztTabLabelDirective>;
  @ViewChild(YztTabsInkBarDirective) _inkBar: YztTabsInkBarDirective;
