...
import {InputTextModule} from "@core/primeng/inputtext/inputtext";
import {ButtonModule} from "@core/primeng/button/button";
import {PrimeNGSharedModule, PrimeTemplate} from "@core/primeng/common/shared";
import { ObjectUtils } from '@core/primeng/utils/objectutils';
import { DomHandler } from '@core/primeng/dom/domhandler';
...
@Component({
    ...
    template: `
        <span [ngClass]="{'ui-autocomplete ui-widget':true,'ui-autocomplete-dd':dropdown,'ui-autocomplete-multiple':multiple}" [ngStyle]="style" [class]="styleClass">
            ...
            [ngClass]="{'ant-input':true,'ui-autocomplete-dd-input':dropdown}"
            >
...
@NgModule({
    imports: [CommonModule, InputTextModule, ButtonModule, PrimeNGSharedModule],
    exports: [AutoComplete, PrimeNGSharedModule],
