...
import { PrimeNGSharedModule, PrimeTemplate } from '../common/shared';
        ...
        <div [class]="styleClass" [ngStyle]="style" [ngClass]="{'ui-picklist ui-widget ui-helper-clearfix': true,'ui-picklist-responsive': responsive}">
            <div class="ui-picklist-source-controls ui-picklist-buttons" *ngIf="showSourceControls">
               <!-- <div class="ui-picklist-buttons-cell">
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-up" [disabled]="disabled" (click)="moveUp(sourcelist,source,selectedItemsSource,onSourceReorder)"></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-double-up" [disabled]="disabled" (click)="moveTop(sourcelist,source,selectedItemsSource,onSourceReorder)"></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-down" [disabled]="disabled" (click)="moveDown(sourcelist,source,selectedItemsSource,onSourceReorder)"></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-double-down" [disabled]="disabled" (click)="moveBottom(sourcelist,source,selectedItemsSource,onSourceReorder)"></button>
                </div> -->
            </div>
            <div class="ui-picklist-listwrapper ui-picklist-source-wrapper" [ngClass]="{'ui-picklist-listwrapper-nocontrols':!showSourceControls}">
                ...
                <div class="ui-picklist-filter-container ui-widget-content" *ngIf="filterBy && showSourceFilter !== false">
                    <input nz-input #sourceFilter type="text" role="textbox" (keyup)="onFilter($event,source,-1)" class="ui-inputtext ui-widget ui-state-default ui-corner-all" [disabled]="disabled" [attr.placeholder]="sourceFilterPlaceholder">
                    <span class="fa fa-search"></span>
                </div>
                <div class="ui-picklist-header" *ngIf="headerLeftTemplate">
                    <ng-container *ngTemplateOutlet="headerLeftTemplate"></ng-container>
                </div>
                <div class="ui-picklist-header" *ngIf="headerTemplate">
            ...
            <div class="ui-picklist-buttons">
                <div class="ui-picklist-buttons-cell">
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small"  [disabled]="disabled" (click)="moveRight()"><i class="anticon anticon-right"></i></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" [disabled]="disabled" (click)="moveAllRight()"><i class="anticon anticon-double-right"></i></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" [disabled]="disabled" (click)="moveLeft()"><i class="anticon anticon-left"></i></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" [disabled]="disabled" (click)="moveAllLeft()"><i class="anticon anticon-double-left"></i></button>
                </div>
            </div>
            <div class="ui-picklist-listwrapper ui-picklist-target-wrapper" [ngClass]="{'ui-picklist-listwrapper-nocontrols':!showTargetControls}">
                ...
                <div class="ui-picklist-filter-container ui-widget-content" *ngIf="filterBy && showTargetFilter !== false">
                    <input nz-input #targetFilter type="text" role="textbox" (keyup)="onFilter($event,target,1)" class="ui-inputtext ui-widget ui-state-default ui-corner-all" [disabled]="disabled" [attr.placeholder]="targetFilterPlaceholder">
                    <span class="fa fa-search"></span>
                </div>
                <div class="ui-picklist-header" *ngIf="headerTemplate">
                    <ng-container *ngTemplateOutlet="headerTemplate;context:{target:true}"></ng-container>
                </div>
                <div class="ui-picklist-header" *ngIf="headerRightTemplate">
                ...
                <ul #targetlist class="ui-widget-content ui-picklist-list ui-picklist-target ui-corner-bottom" [ngClass]="{'ui-picklist-highlight': listHighlightTarget}" [ngStyle]="targetStyle" (dragover)="onListMouseMove($event,1)" (dragleave)="onListDragLeave()" (drop)="onListDrop($event,1)">
                    <ng-template ngFor let-item [ngForOf]="target" let-i="index" let-l="last">
                        ...
                        <li [ngClass]="{'ui-picklist-item':true,'ui-state-highlight':isSelected(item,selectedItemsTarget), 'ui-state-disabled': disabled}"
                            ...
                            [style.display]="isItemVisible(item, 1) ? 'block' : 'none'"
                            [draggable]="dragdrop" (dragstart)="onDragStart($event, i, 1)" (dragend)="onDragEnd($event)">
                            <ng-container *ngTemplateOutlet="itemTemplate; context: {$implicit: item, index: i,target:true}"></ng-container>
                        </li>
                        <li class="ui-picklist-droppoint" *ngIf="dragdrop&&l" (dragover)="onDragOver($event, i + 1, 1)" (drop)="onDrop($event, i + 1, 1)" (dragleave)="onDragLeave($event, 1)" 
            ...
            <div class="ui-picklist-target-controls ui-picklist-buttons" *ngIf="showTargetControls">
                <!-- <div class="ui-picklist-buttons-cell">
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-up" [disabled]="disabled" (click)="moveUp(targetlist,target,selectedItemsTarget,onTargetReorder)"></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-double-up" [disabled]="disabled" (click)="moveTop(targetlist,target,selectedItemsTarget,onTargetReorder)"></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-down" [disabled]="disabled" (click)="moveDown(targetlist,target,selectedItemsTarget,onTargetReorder)"></button>
                    <button nzType="primary" class="margin-top-5" nz-button nzSize="small" icon="anticon anticon-double-down" [disabled]="disabled" (click)="moveBottom(targetlist,target,selectedItemsTarget,onTargetReorder)"></button>
                </div>  -->
            </div>
        </div>
    `,
...
export class PickList implements AfterViewChecked, AfterContentInit {
    ...
    public itemLeftTemplate: TemplateRef<any>;

    public itemRightTemplate: TemplateRef<any>;

    public headerTemplate: TemplateRef<any>;

    public headerLeftTemplate: TemplateRef<any>;
...
@NgModule({
    imports: [CommonModule, ButtonModule, PrimeNGSharedModule,],
    exports: [PickList, PrimeNGSharedModule],
